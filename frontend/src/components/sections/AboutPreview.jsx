...
export default function AboutPreview() {
  return (
    <section data-testid="about-preview" className="relative bg-white py-24 md:py-32 overflow-hidden">
      {/* Sleek 3D network animation in the background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 sn-reveal sn-delay-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-slate-200/80">
              <div className="bg-white/70 backdrop-blur-sm p-5 border border-slate-200/60">
